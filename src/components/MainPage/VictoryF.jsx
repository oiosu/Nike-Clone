    ...
    <VictoryF>
      ...
      <div className="MainText">
        ...
        <div className="content-text">
          포인트 매치로 완성한 호시의 세 가지 보메로 5 스타일링을 확인하고,
        </div>
        <div className="content-text">
          추첨을 통해 50명에게 제품이 제공되는 앱 기프트 이벤트에 응모해보세요
        </div>
      ...
      <div className="GifImg">
        <div className="GifImgSection">
          <img
            src={Gif1}
            alt="Gif1"
            style={{ height: "390px", width: "598px", marginBottom: "20px" }}
          />
          <div className="gif1-text1">한층 더 쉬어진 쇼핑을 즐겨보세요</div>
          <div className="gif1-text2">
            당신만을 위한 제품 추천과 간편 결제 그리고 무료배송
          </div>
          <div className="gif1-text3">
            나이키 앱으로 편리한 쇼핑을 즐겨 보세요.
          </div>
        </div>
        <div className="GifImgSection">
          <img
            src={Gif1}
            alt="Gif1"
            style={{ height: "390px", width: "650px", marginBottom: "20px" }}
          />
          <div className="gif1-text1">한층 더 쉬어진 쇼핑을 즐겨보세요</div>
          <div className="gif1-text2">
            당신만을 위한 제품 추천과 간편 결제 그리고 무료배송
      ...
      <div className="MainText">
        ...
        <div className="content-text">
          에어 포스 1'07과 함께 완전히 새로운 스타일에 도전해 보세요.
        </div>
        <div className="content-text">
          뒤꿈치부터 발끝까지 이어지는 에어 쿠셔닝과 세련된 컬러웨이가
          편안하면서도 아이코닉한 스타일을 선사합니다.
        </div>
        <div className="main-btn">
